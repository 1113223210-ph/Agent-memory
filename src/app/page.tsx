            ...
            <section className="space-y-5">
              <div>
                ...
                <p className="mt-4 max-w-3xl text-sm leading-8 text-zinc-300">
                  我们把之前混在一起的“写入策略”和“污染治理”拆开，真正形成 6 个独立维度。这样首页是地图，详情页是正文，不再出现“标题写 6 个、实际只有 5 个”的结构错位。
                  现在又补了两层总结：先用“全局机制地图”把前面几章重新装回一张总图，再用“不同 agent 类型差异”去解释为什么聊天助手、检索助手、任务型 agent 最后会偏向不同的 memory 组合。这样每个详情页都不只讲概念，也会回到真实 memory architecture 和真实 agent 类型里看。
                </p>
              </div>
